...
public class Office2 : MonoBehaviour
{
    ...
    public bool downloadingComp2;
    public Image eUseImage;
    public Text EToUse;
    public string dialog;
    public bool ePressed;
    public bool OfficeComputer2;
    ...
    void Update()
    {
        ...
        if (playerScript.useOffice2Comp == true)                   //if player presses e
        {
            off2Slider.gameObject.SetActive(true);      //show download bar
            eUseImage.gameObject.SetActive(false);      //deactivate popup box
            downloadingComp2 = true;                    //downloading from computer 2 is true
